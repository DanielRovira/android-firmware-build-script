...
cp -r -a $SCRIPTS/$ROM/files/device_motorola_nairo_BoardConfig.mk $HD/$ROM/device/motorola/nairo/BoardConfig.mk
cp -r -a $SCRIPTS/$ROM/files/vendor_motorola_nairo_BoardConfig.mk $HD/$ROM/vendor/motorola/nairo/BoardConfig.mk
cp -r -a $SCRIPTS/$ROM/files/vendor_motorola_sm7250-common_BoardConfig.mk $HD/$ROM/vendor/motorola/sm7250-common/BoardConfig.mk
